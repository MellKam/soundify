...
export interface components {
	schemas: {
		...
		PlaylistOwnerObject:
			& components["schemas"]["PlaylistUserObject"]
			& ({
				/** @description The name displayed on the user's profile. `null` if not available. */
				display_name?: string | null;
			});
		...
		SimplifiedAudiobookObject:
			& components["schemas"]["AudiobookBase"]
			& Record<string, never>;
		AlbumBase: {
			/**
	...
	responses: {
		...
		PagedFeaturedPlaylists: {
			content: {
				"application/json":
					components["schemas"]["PagingFeaturedPlaylistObject"];
			};
		};
		...
		PagingSimplifiedTrackObject: {
			content: {
				"application/json":
					components["schemas"]["PagingSimplifiedTrackObject"];
			};
		};
		/** @description Pages of tracks */
		...
		PagingArtistDiscographyAlbumObject: {
			content: {
				"application/json":
					components["schemas"]["PagingArtistDiscographyAlbumObject"];
			};
		};
		/** @description Pages of albums */
		...
		PagingSimplifiedAudiobookObject: {
			content: {
				"application/json":
					components["schemas"]["PagingSimplifiedAudiobookObject"];
			};
		};
		...
		PagingSimplifiedChapterObject: {
			content: {
				"application/json":
					components["schemas"]["PagingSimplifiedChapterObject"];
			};
		};
