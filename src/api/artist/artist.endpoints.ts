...
import { AlbumGroup, AlbumSimplified } from "../album/album.types";
 ...
 */
export const getArtists = async (client: HTTPClient, artist_ids: string[]) => {
  return (
...
export const getArtistTopTracks = async (
  ...
  return (
    await client.fetch<{ tracks: Track[] }>(
...
export const getArtistRelatedArtists = async (
  ...
  return (
    await client.fetch<{ artists: Artist[] }>(
