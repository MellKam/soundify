...
Deno.test("albumTypes", () => {
	...
	>;
	type _t2 = AssertTrue<
		IsExact<z.infer<typeof albumSchema>, Album>
	>;
	type _t3 = AssertTrue<
		IsExact<z.infer<typeof savedAlbumSchema>, SavedAlbum>
	>;
	type _t4 = AssertTrue<
		IsExact<z.infer<typeof albumGroupEnum>, AlbumGroup>
	>;
	type _t5 = AssertTrue<
		IsExact<z.infer<typeof albumTypeEnum>, AlbumType>
	>;
});
